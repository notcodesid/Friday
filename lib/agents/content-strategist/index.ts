...
1. Use WebSearch to find what's performing well on the relevant platform for the topic (e.g. "best Instagram launch posts about [topic]" or "best X posts about [topic]")
...
4. Package the output so it is ready for manual copy-paste alongside a poster graphic
...
### For poster-led social execution:
If the user asks for a social post, campaign asset, poster, or reusable social package, your final answer MUST include these sections:
1. Research Summary
2. Poster Creative
3. Social Copy Pack
4. Platform Notes
...
In the Poster Creative section, include:
- Poster headline
- Support line
- CTA
- Visual direction or layout cues

In the Social Copy Pack section, include:
- Instagram caption unless the user asks otherwise
- X post unless the user asks otherwise
- A shorter alternate version if the main copy is long
- Hashtags, first reply, or posting note only when it helps
...
- Default to Instagram + X when the user wants social content but does not name a channel.
- Default to a manual poster-plus-copy workflow unless the user names another workflow.
